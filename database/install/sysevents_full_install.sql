...
PRINT N'Applying 059_create_event_contact_messages.sql';

IF NOT EXISTS (
  SELECT 1
  FROM dbo.schema_migrations
  WHERE filename = N'059_create_event_contact_messages.sql'
)
BEGIN
  BEGIN TRY
    BEGIN TRANSACTION;
...
END;
    ...
    INSERT INTO dbo.schema_migrations (filename)
    VALUES (N'059_create_event_contact_messages.sql');
...
ELSE
BEGIN
  PRINT N'Skipping 059_create_event_contact_messages.sql; already applied';
END;
GO

PRINT N'Applying 060_add_featured_event_speaker.sql';

IF NOT EXISTS (
  SELECT 1
  FROM dbo.schema_migrations
  WHERE filename = N'060_add_featured_event_speaker.sql'
)
BEGIN
  BEGIN TRY
    BEGIN TRANSACTION;
...
END;
    ...
    INSERT INTO dbo.schema_migrations (filename)
    VALUES (N'060_add_featured_event_speaker.sql');
...
ELSE
BEGIN
  PRINT N'Skipping 060_add_featured_event_speaker.sql; already applied';
END;
GO

PRINT N'Applying 061_update_cidia_2027_hero_details.sql';

IF NOT EXISTS (
  SELECT 1
  FROM dbo.schema_migrations
  WHERE filename = N'061_update_cidia_2027_hero_details.sql'
)
BEGIN
  BEGIN TRY
    BEGIN TRANSACTION;
...
WHERE theme_key IN (
  ...
  AND (
    ...
    INSERT INTO dbo.schema_migrations (filename)
    VALUES (N'061_update_cidia_2027_hero_details.sql');
...
ELSE
BEGIN
  PRINT N'Skipping 061_update_cidia_2027_hero_details.sql; already applied';
END;
GO

PRINT N'Applying 062_repair_cidia_2027_hero_details.sql';

IF NOT EXISTS (
  SELECT 1
  FROM dbo.schema_migrations
  WHERE filename = N'062_repair_cidia_2027_hero_details.sql'
)
BEGIN
  BEGIN TRY
    BEGIN TRANSACTION;
...
SELECT
  ...
  @updated_themes AS updated_themes;
    ...
    INSERT INTO dbo.schema_migrations (filename)
    VALUES (N'062_repair_cidia_2027_hero_details.sql');
...
ELSE
BEGIN
  PRINT N'Skipping 062_repair_cidia_2027_hero_details.sql; already applied';
END;
GO

PRINT N'Applying 063_add_team_members_and_automatic_certificates.sql';

IF NOT EXISTS (
  SELECT 1
  FROM dbo.schema_migrations
  WHERE filename = N'063_add_team_members_and_automatic_certificates.sql'
)
BEGIN
  BEGIN TRY
    BEGIN TRANSACTION;
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'uq_event_certificates_recipient' AND object_id = OBJECT_ID('dbo.event_certificates'))
  CREATE UNIQUE INDEX uq_event_certificates_recipient
    ...
    INSERT INTO dbo.schema_migrations (filename)
    VALUES (N'063_add_team_members_and_automatic_certificates.sql');
...
ELSE
BEGIN
  PRINT N'Skipping 063_add_team_members_and_automatic_certificates.sql; already applied';
END;
GO

PRINT N'Creating SaaS platform administrator';

DECLARE @adminEmail NVARCHAR(255) = N'admin@sysevents.local';
DECLARE @adminPasswordHash NVARCHAR(255) = N'$2b$12$roTVNGExtmQkx2R19v4jO.U0HHiAml/CNZ38r6C7Hmy39.7mTMEGq';
DECLARE @adminFirstName NVARCHAR(120) = N'SysEvents';
DECLARE @adminLastName NVARCHAR(120) = N'Admin';
