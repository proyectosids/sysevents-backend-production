...
const contact_messages_routes_1 = require("./modules/communications/presentation/contact-messages.routes");
...
function createApp() {
    ...
    app.use('/api/events', contact_messages_routes_1.contactMessagesRouter);
    ...
    app.use('/api/public', contact_messages_routes_1.publicContactMessagesRouter);
