...
const envSchema = zod_1.z.object({
    ...
    DB_ENCRYPT: zod_1.z.coerce.boolean().default(false),
    DB_TRUST_SERVER_CERTIFICATE: zod_1.z.coerce.boolean().default(true),
    ...
    LOGIN_RATE_LIMIT_MAX_REQUESTS: zod_1.z.coerce.number().default(5),
